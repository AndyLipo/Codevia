...
BEGIN
    ...
    IF p_codigo_zona IS NULL
       OR UPPER(TRIM(p_codigo_zona)) NOT IN ('A', 'B', 'C') THEN
        RAISE EXCEPTION 'La zona debe ser A, B o C.';
    END IF;
    ...
    ------------------------------------------------------------
    -- 2. VALIDAR QUE EL DEPÓSITO EXISTA Y ESTÉ ACTIVO
    ------------------------------------------------------------
    ...
    ------------------------------------------------------------
    -- 3. VERIFICAR SI YA EXISTE LA CONFIGURACIÓN
    ------------------------------------------------------------
    ...
    ------------------------------------------------------------
    -- 4. SI YA EXISTE, NO VOLVER A GENERAR
    ------------------------------------------------------------
    ...
    ------------------------------------------------------------
    -- 8. DEVOLVER ID DE LA CONFIGURACIÓN
    ------------------------------------------------------------
