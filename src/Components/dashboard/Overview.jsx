        ...
        <>
            <SectionTitle
                ...
                action={
                    <div className="title-actions">
                        <button className="secondary-cta" onClick={() => fakeAction("Vista actualizada")}>
                            <RefreshCw size={16} /> Actualizar
                        </button>
                        <button className="primary-cta" onClick={() => navigate("dispatch")}>
            ...
            <div className="alert-strip">
                ...
                <div>
                    ...
                    <span>El lote PLA-014 vence en 25 días y el stock está por debajo del mínimo operativo.</span>
                </div>
                <button onClick={() => navigate("warehouse")}>Revisar alertas <ArrowUpRight size={15} /></button>
            </div>
            ...
            <div className="dashboard-grid">
                <div className="panel wide">
                    <div className="panel-heading">
                        <div><div className="eyebrow">FLUJO OPERATIVO</div><h3>Estado de producción</h3></div>
                        <button className="link-button" onClick={() => navigate("production")}>Ver módulo <ArrowUpRight size={15} /></button>
                    </div>
                    <div className="flow-chart">
                        <div className="flow-summary">
                            ...
                            <small><span>104.240 kg producidos</span><span>120.600 kg planificados</span></small>
                        </div>
                        <div className="bar-chart">
                            {[62, 75, 48, 86, 72, 94, 66].map((height, i) => (
                                <div className="bar-col" key={i}>
                                    <div className={`bar ${i === 3 ? "today" : ""}`} style={{ height: `${height}%` }}>
                ...
                <div className="panel">
                    <div className="panel-heading">
                        <div><div className="eyebrow">EXPEDICIÓN</div><h3>Actividad en playa</h3></div>
                        <button className="icon-button" onClick={() => navigate("dispatch")}><ArrowUpRight size={16} /></button>
                    </div>
                    ...
                    <button className="secondary-cta full" onClick={() => navigate("dispatch")}>Abrir tablero de cargas</button>
                </div>
            </div>

            <div className="panel table-panel">
                <div className="panel-heading">
                    <div><div className="eyebrow">ÚLTIMOS MOVIMIENTOS</div><h3>Pedidos para preparar</h3></div>
                    <button className="link-button" onClick={() => navigate("orders")}>Ver todos <ArrowUpRight size={15} /></button>
                </div>
                <Table
                    ...
                    renderCell={(cell, j) =>
                        j === 4 ? <Badge tone={cell === "Listo para picking" ? "green" : cell === "En preparación" ? "amber" : "blue"}>{cell}</Badge> : cell
                    }
                />
            </div>
        </>
