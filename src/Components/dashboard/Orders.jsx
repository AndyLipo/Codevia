    ...
    return (
        <>
            <SectionTitle
                ...
                action={<button className="primary-cta" onClick={() => fakeAction("Alta de pedido en preparación")}><Plus size={17} /> Nuevo pedido</button>}
            />

            <div className="order-kpis">
                <div><span>Pedidos del mes</span><strong>184</strong><small>+12,6% vs. mes anterior</small></div>
                <div><span>Tiempo medio de confirmación</span><strong>02:18 h</strong><small>Objetivo: 04:00 h</small></div>
                <div><span>Clientes activos</span><strong>42</strong><small>6 con entrega esta semana</small></div>
            </div>

            <div className="panel table-panel">
                <div className="panel-heading">
                    <div><div className="eyebrow">CARTERA ACTIVA</div><h3>Pedidos recientes</h3></div>
                    <div className="table-tools">
                        <button className="secondary-cta"><Search size={15} /> Buscar</button>
                        <button className="secondary-cta"><UsersRound size={15} /> Clientes</button>
                    </div>
                </div>
                <Table
